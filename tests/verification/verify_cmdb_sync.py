...
class TestCMDBSync(unittest.TestCase):
    def setUp(self):
        ...
        # Override dependency
        self.app.dependency_overrides[mock_verify_token] = lambda: {
    ...
    def test_background_sync_logic(self, mock_fetch):
        ...
        mock_assets = [
            ...
            {"name": "server-02", "sys_id": "sys-002", "sys_class_name": "server"},
        ]
    ...
    def test_add_incident_creates_job(self, mock_session, mock_supabase):
        ...
        payload = {"short_description": "Test Incident", "tag_id": "server-01", "source": "manual"}
