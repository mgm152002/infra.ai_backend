...
sys.modules["app.api.routers.incidents"] = (
    MagicMock()
)  # Mock incidents router to avoid get_llm import issues
...
class TestPhase2Integrations(unittest.TestCase):
    def test_servicenow_module(self):
        ...
        with patch.dict(
            os.environ, {"INFISICAL_CLIENT_ID": "test", "INFISICAL_CLIENT_SECRET": "test"}
        ):
    ...
    def test_chatops_service(self):
        ...
        from integrations.chatops import chatops, ChannelType
